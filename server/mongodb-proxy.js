...
app.all('/', function(req, res, next) 
{
  ...
  MongoClient.connect(req.body.db.url, {readPreference:"secondary"}, function(err, client)
  {
    if ( err != null )
    {
...
{
  MongoClient.connect(body.db.url, {readPreference:"secondary"}, function(err, client) 
  {
    if ( err != null )
    {
 ...
 if ( queryArgs.err == null)
  {
    ...
    MongoClient.connect(db.url, {readPreference:"secondary"}, function(err, client) 
    {
      if ( err != null )
      {
        queryError(requestId, err, next )
